...
How-to guides solve focused tasks. Use them when you already know what you want
to do and need the shortest reliable path.

## Available guides

* [Create a benchmark matrix](create-benchmark-matrix.md), for comparing
...
Use tutorials for guided learning. Use reference pages when checking stable API,
configuration, or compatibility details.
